...
public class RegisterActivity extends AppCompatActivity {
    ...
    TextInputLayout huesped_nombre,huesped_apellido,huesped_email,huesped_passowrd,repet_password;
    String nombre,apellido,email,passowrd,repetPassword;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_register.setOnClickListener(v -> {
            if (saveHuesped()){
                huesped = new Huesped(nombre,apellido,passowrd,email);
    ...
    boolean saveHuesped(){
        ...
        if (nombre.isEmpty() || apellido.isEmpty( )|| passowrd.isEmpty()|| email.isEmpty()){
            Toast.makeText(this,"Todos los campos son requeridos",Toast.LENGTH_LONG).show();
            return false;
        }else if(!passowrd.equals(repetPassword)){
            Toast.makeText(this,"el password son diferentes",Toast.LENGTH_LONG).show();
            return false;
        }else
            return true;
    }
